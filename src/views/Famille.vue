<template>
  <div class="famille bg-[#FFFBF8] text-[#2E2B29] min-h-screen">
    ...
    <!-- Section philosophie et approche -->
    <section class="py-8 md:py-12 px-4">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 md:p-12">
            ...
            <div>
              ...
              <div class="prose prose-lg">
                <p class="text-lg leading-relaxed mb-6 text-[#2E2B29]">
                  J'aime profiter de l'extérieur pour photographier les amoureux, les
                  enfants ou toute la famille. Vous êtes libres de vos mouvements avec la
                  possibilité d'utiliser l'espace dont vous avez envie et moi je suis là
                  (toujours) pour photographier ce sourire, ce fou rire, ce baiser ou ce
                  regard si particulier.
                </p>

                <p class="text-lg leading-relaxed mb-6 text-[#2E2B29]">
                  Vous êtes libre et donc libre de choisir la séance qui vous correspond le plus. 
                  En intérieur ou en extérieur ou même les deux, les seules choses sont de : 
                  se faire plaisir et me faire confiance.
                </p>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="space-y-6">
                <div class="bg-[#FFFBF8] rounded-lg p-6">
                  <h4 class="font-semibold text-[#2E2B29] mb-3 flex items-center">
                    <span class="text-[#C2A191] mr-2">🏠</span>
                    Studio
                  </h4>
                  <p class="text-[#2E2B29] mb-3">
                    Séances en studio avec matériel professionnel et décors variés.
                  </p>
                </div>
                ...
                <div class="bg-[#FFFBF8] rounded-lg p-6">
                  ...
                  <p class="text-[#2E2B29] mb-3">
                    ...
                    <span class="font-semibold text-[#C2A191]">Supplément : +45€</span>
                  </p>
                </div>
              </div>
            </div>
          ...
          <div class="mt-12 text-center">
            <p class="text-lg text-[#2E2B29] mb-6">
              Si vous souhaitez réaliser des clichés à l'extérieur et qu'un endroit vous est cher, 
              n'hésitez pas à me le notifier dans la partie commentaire sur ma page 
              <router-link 
                to="/formulaire" 
      ...
      <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center">
              ...
              <div class="space-y-4 mb-8">
                <div class="flex items-start space-x-3">
                  <span class="text-[#C2A191] text-xl">📷</span>
                  <p class="text-sm text-[#2E2B29] leading-relaxed">
                    Séance Maman et moi en studio ou en extérieur d'1h30 (Max 2 enfants)
                  </p>
                </div>
            ...
            <div class="text-center">
              ...
              <div class="space-y-4 mb-8">
                <div class="flex items-start space-x-3">
                  <span class="text-[#C2A191] text-xl">📷</span>
                  <p class="text-sm text-[#2E2B29] leading-relaxed">
                    Séance famille en studio ou en extérieur de 2h00 (parents et 2 enfants maximum)
                  </p>
                </div>
        ...
        <div class="mt-12 bg-white rounded-2xl shadow-lg p-8">
          ...
          <div class="grid md:grid-cols-2 gap-8">
            <div class="text-center">
              <div class="bg-[#C2A191]/10 rounded-full w-16 h-16 flex items-center justify-center mx-auto mb-4">
            ...
            <div class="text-center">
              ...
              <p class="text-[#2E2B29] text-sm">
                Séances en extérieur dans des lieux naturels ou qui vous sont chers
              </p>
            </div>
          </div>
        </div>
    ...
    <section class="py-12 px-4">
      <div class="max-w-4xl mx-auto text-center">
        <div class="bg-gradient-to-r from-[#C2A191] to-[#ad8e80] rounded-2xl p-8 md:p-12">
          ...
          <router-link
            to="/formulaire"
            class="inline-flex items-center px-8 py-4 bg-white font-semibold rounded-full hover:bg-gray-100 transition-all duration-300 transform hover:scale-105"
            style="color: #C2A191 !important;"
          >
